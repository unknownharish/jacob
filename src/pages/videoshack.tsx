        ...
        <>
            <div className='  bg-[#f4f481] h-screen w-[100vw] flex flex-col justify-center items-center '>
                ...
                <div className='relative  '>
                    ...
                    <img src="/images/yt/connect.png" className='absolute top-[13vh] left-[0vw] lg:top-[8vh] lg:left-[7vw] lg:w-5/6 xl:top-8 xl:left-[16vw] xl:w-4/6 cursor-pointer' alt="" onClick={() => console.log('he')} />
