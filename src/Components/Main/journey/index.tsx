...
export default function Journey() {
    ...
    let imgs = [
        ...
        {src:'/images/journey/AMAZONE.png',href:'https://saveamazon.dugut.app/',text:'Save the Amazon rainforest by engaging in this journey about the natives who protect it! Learn about the struggle against the local government to keep their home safe and fund the solution!',head:'Save the Amazon'},
        ...
        {src:'/images/journey/REFUGGEE.png',href:'https://refugeecrisis.dugut.app/',text:'Refugees are forced from their home and culture to survive and provide a better life for their family. Learn about their struggles and take action in this journey to help provide funding and raise donations for real help on the ground for the refugee crisis.',head:'Refugee Crisis'},
        {src:'/images/journey/WIND.png',href:'https://renewableenergy.dugut.app/',text:'Learn how wind energy is changing our world, how fast this technology has been able to grow and become a integral part of our renewable energy and sustainability strategy! Take action and join our campaign to raise awareness for renewables and climate change!',head:'Wind Energy (General)'},
        {src:'/images/journey/VIENTO.png',href:'https://viento.dugut.app/',text:'Aprenda sobre la energía eólica y su poder para convertirse en una fuente de energía sostenible en nuestro futuro. ¡Aprende datos interesantes y termina el viaje para desbloquear una acción sostenible!',head:'Viento Energia Renovável (Spanish)'},
